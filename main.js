...
const config = {
    particleSize: 1.0,  // Slightly reduced from 1.2 to better capture fine details
    mouseRadius: 50,
    mouseStrength: 200,
    morphSpeed: 0.05,

    // Adjusted scales for better detail preservation
    deltaLogoScale: 0.055,
    deltaColorBoost: 1.1,
    deltaZSpread: 0.15,
    deltaYOffset: 1.5,

    // Matrix logo adjustments for better detail
...
function animate() {
    ...
    // Mouse only when not morphing and idle
    if (!isMorphing && isIdle) {
